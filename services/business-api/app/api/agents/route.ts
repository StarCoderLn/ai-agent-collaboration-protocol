 ...
 * Next.js App Router Route Handler 接线，不包含任何业务规则。
 *
 ...
 * `next build` 收集路由配置阶段不一定存在。
 */
import { createAgentHttpHandler } from "../../../src/http/create-agent-handler";
import { createProductionCreateAgentDeps } from "../../../src/http/create-agent-production-deps";
