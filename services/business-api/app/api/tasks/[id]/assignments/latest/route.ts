...
function getHandlers() { return handlers ??= createTaskDispatchHandlers(createProductionTaskDispatchDeps(createProductionResolveActorId())); }
export function GET(request: Request, context: TaskDispatchRouteContext): Promise<Response> { return getHandlers().latestAssignment(request, context); }
