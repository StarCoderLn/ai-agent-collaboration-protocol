...
export type TaskStatus =
  | "draft" | "planning" | "awaiting_escrow" | "matching" | "awaiting_agent_acceptance"
...
const transitions: Readonly<Record<TaskStatus, Readonly<Partial<Record<TaskTransitionEvent["type"], TaskStatus>>>>> = {
  ...
  executing: { result_submitted: "awaiting_review", execution_failed: "execution_failed", workflow_final_accepted: "pending_settlement", workflow_settlement_confirmed: "settled", deadline_elapsed: "timed_out", dispute_opened: "disputed" },
  awaiting_review: { rework_requested: "rework", result_accepted: "pending_settlement", workflow_final_accepted: "pending_settlement", workflow_settlement_confirmed: "settled", dispute_opened: "disputed" },
