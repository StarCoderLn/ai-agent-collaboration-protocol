...
import { parseSessionCookie, serializeSessionCookie, SESSION_COOKIE_NAME } from "./session-cookie.js";

describe("session-cookie", () => {
  it("serializes an httpOnly+Secure+SameSite=Lax cookie (design.md 模块 5)", () => {
    const cookie = serializeSessionCookie("abc123", new Date("2026-08-23T00:00:00.000Z"));
  ...
  it("round-trips a URI-encoded value", () => {
    const cookie = serializeSessionCookie("a b/c", new Date("2026-08-23T00:00:00.000Z"));
