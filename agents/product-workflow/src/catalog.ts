...
export const WORKFLOW_AGENT_CATALOG: readonly WorkflowAgentManifest[] = [
  ...
  },
  {
    ...
    tags: ["ui/ux", "agent"],
    priceMinor: "1600000000000000",
    step: "design",
    strategy: "direct",
    name: "快速界面设计 Agent",
    description: "一次生成设计 token、页面结构、组件和交互规范。",
  },
  {
    id: "design-mastra",
    ...
    priceMinor: "2200000000000000",
    step: "design",
    strategy: "mastra",
    name: "Mastra 产品设计 Agent",
    description: "由 Mastra 约束结构化设计稿，强调需求到设计元素的可追溯性。",
  },
  {
    ...
    tags: ["ui/ux", "agent"],
    priceMinor: "2800000000000000",
    step: "design",
    strategy: "state-machine",
    name: "设计评审与完善 Agent",
    description: "先制定设计方向，再生成并校验状态、响应式和素材覆盖情况。",
  },
  {
    id: "code-direct",
    ...
    strategy: "direct",
    name: "快速代码生成 Agent",
    description: "DeepSeek 直接根据需求与设计生成代码制品，作为速度和成本基线。",
  },
  {
    id: "code-mastra",
    ...
    priceMinor: "3200000000000000",
    step: "code",
    strategy: "mastra",
    name: "Mastra 编程 Agent",
    description: "使用 Mastra 生成文件树、代码、运行说明和测试计划。",
  },
  {
    ...
    tags: ["typescript", "next.js", "agent"],
    priceMinor: "4200000000000000",
    step: "code",
    strategy: "state-machine",
    name: "规划测试修复 Coding Agent",
    description: "显式执行规划、编码、静态校验和一次修复，强调可运行性。",
  },
];
