...
/** 生产装配只在首个请求时读取环境变量，构建阶段不会尝试连接内部服务。 */
export function createProductionTaskDispatchDeps(
	resolveActorId: TaskDispatchHttpDeps["resolveActorId"],
