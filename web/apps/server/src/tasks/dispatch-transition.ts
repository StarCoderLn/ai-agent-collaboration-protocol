 ...
 */
export const dispatchTransitionInputSchema = z
	.object({
		eventId: uuid,
		assignmentId: uuid,
		eventType: z.enum([
...
export type DispatchTransitionInput = z.infer<
	typeof dispatchTransitionInputSchema
>;
...
export function asTaskTransitionEvent(
	input: DispatchTransitionInput,
): TaskTransitionEvent {
