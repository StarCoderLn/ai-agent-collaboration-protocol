...
export function GET(request: Request, context: WorkflowPlanRouteContext) {
	return getHandlers().read(request, context);
}
export function PUT(request: Request, context: WorkflowPlanRouteContext) {
	return getHandlers().update(request, context);
}
