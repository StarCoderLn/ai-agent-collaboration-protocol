...
const agents = [
	...
	{ initials: "DEV", name: "高质量 Coding Agent", category: "代码开发", rating: "4.9", jobs: "78 次交付", tags: ["Next.js", "自动化测试"], tone: "bg-tertiary-container text-tertiary-container-foreground" },
